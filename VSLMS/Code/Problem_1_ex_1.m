...
[w,~]=VSLMS(inputs,d,N,alpha_int,M,alpha_max);
...
for i=1:k
    [~,cost]=VSLMS(inputs,d,N,alpha_int,M,alpha_max);
...
[~,~,J_min,J_inf]=VSLMS(inputs,d,N,alpha_int,M,alpha_max);
J_ex=J_inf - J_min;
